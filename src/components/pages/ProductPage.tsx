...
export function ProductPage({ slug }: { slug: string }) {
  ...
  return <><Nav /><main id="top" className="product-editorial-page bg-[#eef3f6] text-[#111927]">
    ...
    <section className="relative overflow-hidden bg-[#111927] px-5 py-24 text-white sm:px-8 sm:py-32 lg:px-12 lg:py-40"><div className="mx-auto grid max-w-[1500px] gap-16 lg:grid-cols-[.85fr_1.15fr] lg:items-center"><div><p className="text-[11px] uppercase tracking-[.16em] text-white/60">{product.agent.name} · always on</p><h2 className="mt-7 max-w-[680px] font-serif text-[clamp(2.1rem,4vw,4.25rem)] font-light leading-[1.02] tracking-[-.045em]">{product.agent.line}</h2></div><div className="relative aspect-square overflow-hidden rounded-full border border-white/25 bg-[#061e2a]"><img src={scene} alt="" className="size-full object-cover" /></div></div></section>

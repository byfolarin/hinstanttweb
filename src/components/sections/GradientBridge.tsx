...
export function GradientBridge() {
  return (
    <section className="gradient-bridge relative h-[68svh] min-h-[560px] overflow-hidden bg-[#111927]">
      ...
      <div className="gradient-tablet absolute left-1/2 top-[68%] z-10 aspect-[16/10] w-[min(1120px,90vw)] -translate-x-1/2 -translate-y-1/2 rounded-[32px] border border-white/25 bg-[#090d15] p-[10px] shadow-[0_55px_130px_rgba(2,5,12,.5)] sm:rounded-[42px] sm:p-[14px]">
        <div className="relative size-full overflow-hidden rounded-[24px] bg-white sm:rounded-[31px]">
          <img src={dashboard} alt="Hinstantt finance dashboard displayed on a tablet" className="size-full object-cover object-top" />
